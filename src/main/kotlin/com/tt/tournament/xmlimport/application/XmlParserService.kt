...
class XmlParserService {
    ...
    fun parseTournamentXml(xmlContent: String): TournamentXMLDto {
        try {
            val jaxbContext = JAXBContext.newInstance(TournamentXMLDto::class.java)
            ...
            val source = InputSource(StringReader(xmlContent))
            val saxSource = SAXSource(xmlReader, source)

            return unmarshaller.unmarshal(saxSource) as TournamentXMLDto
