package com.tt.tournament.xmlimport.infrastructure.rest
...
class AutomaticImportIT(
    ...
    fun `Given saturday endpoint fails when Saturday import triggered then returns error response`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(jsonPath("$.errors[0]").value(Matchers.containsString("Failed to download XML")))
    }
